...
public class CenterSelectionPanel extends JPanel{
	...
	public CenterSelectionPanel() {
		...
		//File folder = new File("D:\\Users\\Cayon\\Documents\\EnsimElec\\Robot Cities\\RobotPrincipal2018\\filepoint3.0");
		File folder = new File("/home/pi/PreCoupeNemaFusion/filepoint3.1");
