...
public class CenterActionPanel extends JPanel{
	...
	File racine = new File("/home/pi/PreCoupeNemaFusion/fileaction/");
	...
	public CenterActionPanel() {
		...
		//File folder = new File("D:\\Users\\Cayon\\Documents\\EnsimElec\\Robot Cities\\RobotPrincipal2018\\fileaction");
		File folder = new File("/home/pi/PreCoupeNemaFusion/fileaction");
