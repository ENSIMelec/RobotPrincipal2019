...
//Moteur Gauche
#define enA_Gauche 9  //Marron
#define in2_Gauche 10 //Rouge
#define in1_Gauche 11 //Noire

//Moteur Droite
#define enB_Droite 6  //Jaune
#define in4_Droite 8  //Orange
#define in3_Droite 7  //Vert
